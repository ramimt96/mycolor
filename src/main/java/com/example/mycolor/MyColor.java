...
public enum MyColor {
    ...
    /*Attempted to create goldenRatioColor method

    public double getHue(color) {
        return Color.color.getHue();
    }
    public Color GoldenRatioColor(MyColor color) {
        double goldenRatio = 0.61803398875;
        double hue = (color.getHue() + goldenRatio) % 1.0;
        double saturation = getSaturation();
        double brightness = getBrightness();
        return new MyColor(Color.hsb(hue, saturation, brightness));
    }*/
